...
namespace core
{
	VulkanGraphicsPipeline::VulkanGraphicsPipeline(VkDevice logicDevice, VkRenderPass renderPass)
	{
        ...
        if (vkCreatePipelineLayout(logicDevice, &pipelineLayoutInfo, nullptr, &m_PipelineLayout) != VK_SUCCESS) {
        ...
        if (vkCreateGraphicsPipelines(logicDevice, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &m_GraphicsPipeline) != VK_SUCCESS) {
